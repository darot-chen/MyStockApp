...
class _ProductInScreenState extends State<ProductInScreen> {
  ...
  int _quantityResutl;
  String _lifeStatus;
  String _lifeStatusResutl;
  DateTime _selectedDate;

  @override
  void initState() {
    // _productName = 'Choose Product';
    _lifeStatusResutl = '';
    isValidate = true;
  ...
  _saveForm() {
    ...
    if (_productId != null) {
      ...
      if (form.validate()) {
        form.save();
        _quantityResutl = _quantity;
        _lifeStatusResutl = _lifeStatus;
        _selectedDate = calendarController.selectedDate ?? _selectedDate;
        _updateProduct(_productId, _quantityResutl);
  ...
  _updateProduct(String id, int numOfStock) {
    for (int i = 0; i < products.length; i++) {
      if (products[i].id == id) {
        products[i].numOfStock += numOfStock;
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    String selectedDate = formater.format(_selectedDate);
  ...
  InkWell chooseProductBtn(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          _productId != null ? '$_productName - $_productId' : 'Choose Product',
          style: TextStyle(
            fontSize: 18,
            color: Colors.white,
            fontWeight: FontWeight.w700,
